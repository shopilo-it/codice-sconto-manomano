#!/usr/bin/env python3
"""
Recupero codici sconto ManoMano da shopilo.it
Sursa: https://shopilo.it/negozi/manomano.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/manomano.it"
STORE_NAME = "ManoMano"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per ManoMano da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-manomano)"
    }
    try:
